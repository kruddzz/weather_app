...
$(document).ready(function() {
  ...
  function searchWeather(searchValue) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/weather?q=" + searchValue + "&appid=0ab6dfb51cca2642d6975b1374fdbe58&units=imperial",
      dataType: "json",
  ...
  function getForecast(searchValue) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=0ab6dfb51cca2642d6975b1374fdbe58&units=imperial",
      dataType: "json",
      success: function(data) {
        // console.log(data);
  ...
  function getUVIndex(lat, lon) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/uvi?appid=0ab6dfb51cca2642d6975b1374fdbe58&lat=" + lat + "&lon=" + lon,
      dataType: "json",
      success: function(data) {
